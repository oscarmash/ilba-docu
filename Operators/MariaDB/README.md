...
Por desgracia, esta feature (PhysicalBackup), ha sido introducida en la versión 25.08.0 del operator, que [ha salido a finales de Julio](https://github.com/mariadb-operator/mariadb-operator/releases/tag/25.08.0) y esta documentación, la estoy haciendo en Agosto del 2025 :sweat_smile:
